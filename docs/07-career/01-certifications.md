---
description: ISTQB CTFL v4.0, Advanced levels, AT*SQA micro-credentials, and the honest hierarchy — when certifications are worth your money and when a portfolio beats them.
keywords: [istqb certification, ctfl v4, istqb cost, qa certifications worth it, at sqa micro credentials]
---

# Certifications: An Honest Guide

The certification question gets argued endlessly because both camps are right: certifications **are** overrated by people selling them, and **are** useful in specific, predictable situations. Here's the decision logic, then the catalog.
...
2. **Enterprise/BFSI/regulated clients** — procurement and HR filters genuinely screen for ISTQB; in [those industries](../04-remote-market/01-market-overview.md#whos-hiring) it can be a hard checkbox.
3. **ATS keyword filters** — "ISTQB" in a resume matches a filter many corporate postings include.
...
| Certification | Cost (USD) | Format | Verdict |
|---|---|---|---|
| **ISTQB CTFL v4.0** (Foundation) | ~$229 via AT*SQA / ASTQB; **~$75 via the Indian Testing Board** — same certificate, globally valid | 40 MCQs, 65% to pass, online proctored or test center; **valid for life** | The one to get, if you get one. The ITB price arbitrage is real and legitimate — register through the cheaper national board |
| **ISTQB Agile Tester (CTFL-AT)** | ~$199 | Requires CTFL | Worthwhile only if targeting scrum-heavy enterprise teams |
| **ISTQB Advanced — Test Analyst / Test Manager** | ~$249 each | Requires CTFL + experience expectations | For 3–5+ year career testers eyeing lead roles; irrelevant to beginners |
| **ISTQB Advanced — Test Automation Engineer (TAE)** | ~$249 | Requires CTFL | The most market-relevant Advanced module — but a public Playwright repo with CI demonstrates the same thing cheaper and louder |
| **ISTQB Specialist** (AI Testing, Mobile, Performance, Security) | ~$199 each | Requires CTFL | Useful as *positioning* in a niche you already practice; AI Testing is the interesting newcomer |
...
- **uTest Academy / Test IO Academy completion** — free, practical, and platforms route work based on them ([crowdtesting tier](../04-remote-market/02-platforms-and-marketplaces.md#tier-1--crowdtesting-the-apprenticeship-nobody-tells-beginners-about)).
- **Course certificates** (Coursera, Udemy ~$12–15 sales) — weak as credentials, fine as profile texture and genuinely useful as structured learning. Don't pay more than sale price; never list more than 2–3.
